...
public class TestFragment extends Fragment {
    ...
    String quiz;
    TextView r1Tv, r2Tv, r3Tv, r4Tv, r5Tv, r6Tv, r7Tv, r8Tv, r9Tv, r10Tv;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        refAnswer = FirebaseDatabase.getInstance().getReference().child("Answers").child(quiz);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() { // to get data from firebase
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
                                            builder.setMessage("Do you want to download the answer sheet?");
                                            builder.setPositiveButton("Download", new DialogInterface.OnClickListener() {
                                                @Override
                                                public void onClick(DialogInterface dialog, int which) {//internal memory permission
    ...
    private void downloadAnswers(String ans) {

        try {
            DownloadManager.Request request = new DownloadManager.Request(Uri.parse(ans));
            request.setTitle("test_answer");

            request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "test_answer" + ".pdf");
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(getActivity(), "Answer sheet saved in Downloads", Toast.LENGTH_SHORT).show();
                }
            }, 3000);
